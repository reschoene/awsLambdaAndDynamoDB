...
import br.com.reschoene.model.PersonRequest;
import br.com.reschoene.model.PersonResponse;
...
public class SavePersonHandler implements RequestHandler<PersonRequest, PersonResponse> {
    ...
    private Regions REGION = Regions.SA_EAST_1; //South America - Sao Paulo
